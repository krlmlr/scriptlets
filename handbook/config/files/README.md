...
| [`zshenv`](/rcm/zshenv), [`zshrc`](/rcm/zshrc) | `~/.zshenv`, `~/.zshrc` | zsh: the startup profiler for every shell, completion, history and [`Ctrl-R`](/handbook/config/atuin/README.md) for the interactive ones |
