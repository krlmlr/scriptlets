...
| [`bashrc`](/rcm/bashrc), [`bash_profile`](/rcm/bash_profile), [`bash_aliases`](/rcm/bash_aliases) | `~/.bashrc`, `~/.bash_profile`, `~/.bash_aliases` | interactive bash: prompt, history, aliases, [mise](/handbook/config/mise/README.md), [prompt marks](/handbook/config/prompt-marks/README.md) |
...
| [`zshenv`](/rcm/zshenv), [`zshrc`](/rcm/zshrc) | `~/.zshenv`, `~/.zshrc` | zsh: the startup profiler for every shell, completion, [history](/handbook/config/history/README.md), mise, [prompt marks](/handbook/config/prompt-marks/README.md), the [working directory](/handbook/config/current-directory/README.md) and [`Ctrl-R`](/handbook/config/atuin/README.md) for the interactive ones |
